...
class MagicSlideshow extends Module {
    ...
    private function sendStat($action = '') {
        ...
        if('working' == 'v5.5.17' || 'working' == 'v2.0.15') {
            return;
        }
        ...
        $path = "api/stat/?action={$action}&tool_name=magicslideshow&license=trial&tool_version=v2.0.15&module_version=v5.5.17&platform_name=prestashop&platform_version={$platformVersion}&url={$url}";
