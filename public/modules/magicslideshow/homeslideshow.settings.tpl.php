...
<div style="margin: 10px 0 10px 0;">
In order to show slideshow on any CMS page just insert slideshow shortcode <b>[magicslideshow]</b><?php if($this->isPrestahop15x) echo ' and enable "Include headers on all pages" option'; ?>.<br />
