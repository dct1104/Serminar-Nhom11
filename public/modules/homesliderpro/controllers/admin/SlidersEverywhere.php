...
class SlidersEverywhereController extends AdminController {
	...
	public function headerHTML()
	{
		...
		$this->_html .= '<script type="text/javascript">
			...
			var ajaxUrl = "'._MODULE_DIR_.$this->module->name.'/ajax_'.$this->module->name.'.php?secure_key='.$this->secure_key.'";
						...
						$this->_html .= '
							<li id="slides_'.$slide['id_slide'].'"><i class="fa fa-bars list"></i>
								...
								<p class="icons" >'.
									...
									<a id="deleteSlidePic" href="'.AdminController::$currentIndex.'&token='.Tools::getAdminTokenLite($this->name).'&delete_id_slide='.(int)($slide['id_slide']).'#'.$hookname.'slideConf" title="'.$this->l('Delete').'"><i class="fa fa-trash-o"></i></a>
								</p>
							</li>';
					}
					$this->_html .= '</ul></div>';
